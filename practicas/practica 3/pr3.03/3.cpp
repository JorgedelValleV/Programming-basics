...
//(g) Fucion que reciba un tablero, las coordenadas en que se encuentra la tortuga con la pistola laser y la direccion a la que apunta la tortuga y modi?que el tablero de acuerdo con el resultado del disparo
...
bool resuelveCaso() {
	...
	// LLamada a comprobar si el movimiento es posible
	bool ok = movPosible(tablero, coor, tablero[coor.fila][coor.columna].tortuga.direccion);
